	    ...
	    <div class="form_head text-center">
			...
			<div class="col-md-3 col-md-offset-3 text-right">
				<ul class="nav nav-pills">
  					...
  					<li role="presentation"><a value="back" class="btn-success btn_head"  name="back" href=<?php if($this->session->userdata('privilege') == '2'){ echo site_url("manage_user");} else{ echo site_url("log_out");} ?>>Back</a></li>
				</ul>				
			</div>
		</div>  
	</div>
	  					...
	  					<div class="form-group">
	   						...
	   						<div class="col-md-8">
		    					...
		    					<label class="col-md-8 error_class">
				              		...
				              		<span>
				        			<?php 
										if($this->session->flashdata('already_exist'))
										{ 
											$message = $this->session->flashdata('already_exist');
											echo $message;
										}
									?>
									</span>
